...
const features = [
  {
    ...
    desc: "AI-driven checks ensure parts fit perfectly every time.",
  },
  {
    icon: "💰",
    title: "Price Intelligence",
    desc: "Real-time updates from Star Tech, Ryans, and Tech Land.",
  },
  {
    icon: "🎯",
    title: "Bottleneck Analysis",
    desc: "Optimized scoring to get maximum value for your money.",
  },
];
  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-hidden bg-[#020406] text-white">
        {/* Background Effects */}
        <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_20%_20%,rgba(0,120,255,0.25),transparent_25%),radial-gradient(circle_at_80%_40%,rgba(16,255,160,0.20),transparent_30%),linear-gradient(to_bottom,#020406,#010101)]"></div>

        {/* Top Light Line */}
        <div className="fixed top-20 right-10 h-[2px] w-96 rotate-[-30deg] bg-gradient-to-r from-blue-500 to-emerald-400 blur-sm opacity-70"></div>

        {/* Bottom Light Line */}
        <div className="fixed bottom-20 left-10 h-[2px] w-96 rotate-[20deg] bg-gradient-to-r from-blue-500 to-emerald-400 blur-sm opacity-70"></div>

        <div className="container mx-auto px-6 py-6">
          {/* Main Wrapper */}
          <div className="rounded-[30px] border border-cyan-500/20 bg-black/40 backdrop-blur-xl shadow-[0_0_50px_rgba(0,180,255,0.08)]">
            ...
            <nav className="flex items-center justify-between border-b border-white/10 px-6 py-5 lg:px-10">
              ...
              {/* Menu */}
              <div className="hidden items-center gap-8 md:flex text-sm font-medium text-gray-400">
                <a
                  href="#"
                  className="border-b-2 border-cyan-500 pb-1 text-white"
                >
                  Home
                </a>
              ...
              <div className="flex items-center gap-4">
                <button className="text-sm font-medium hover:text-cyan-400 transition">
                  Login
                </button>

                <button className="rounded-xl bg-gradient-to-r from-blue-500 to-emerald-400 px-6 py-3 text-sm font-bold text-black shadow-[0_0_20px_rgba(16,255,180,0.25)] transition hover:scale-105">
                  Sign Up →
                </button>
              </div>
            </nav>
            ...
            <section className="grid items-center gap-14 px-6 py-20 lg:grid-cols-2 lg:px-14">
              ...
              <div>
                ...
                <p className="mb-8 max-w-xl text-lg leading-relaxed text-gray-400">
                  Build, Compare, and Analyze. Harness the ultimate power with
                  real-time price tracking and compatibility engine.
                </p>
              ...
              <div className="relative">
                {/* Glow */}
                <div className="absolute inset-0 rounded-[35px] bg-gradient-to-r from-blue-500 to-emerald-400 opacity-20 blur-3xl"></div>
                ...
                <div className="relative h-[450px] overflow-hidden rounded-[30px] border border-cyan-500/20 bg-black/40 shadow-[0_0_60px_rgba(0,180,255,0.15)]">
                  ...
                  {/* Overlay */}
                  <div className="absolute inset-0 bg-gradient-to-tr from-black/70 via-transparent to-emerald-500/10"></div>

                  {/* Bottom Glow Bar */}
                  <div className="absolute bottom-6 left-10 right-10 h-4 rounded-full bg-gradient-to-r from-blue-500 to-emerald-400 shadow-[0_0_30px_rgba(16,255,180,0.45)]"></div>
                </div>
              </div>
            </section>
            ...
            <section className="grid gap-6 px-6 pb-20 md:grid-cols-3 lg:px-14">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  {/* Line */}
                  <div className="mb-4 h-[2px] w-16 bg-gradient-to-r from-blue-500 to-emerald-400"></div>
